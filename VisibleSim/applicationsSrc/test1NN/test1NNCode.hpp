...
#ifndef test1NNCode_H_
#define test1NNCode_H_
...
class test1NNCode : public Catoms3DBlockCode
{
private:
...
public:
    test1NNCode(Catoms3DBlock *host);
    ~test1NNCode(){};
    ...
    {
        return (new test1NNCode((Catoms3DBlock *)host));
    }
    /*****************************************************************************/
};

#endif /* test1NNCode_H_ */