...
#ifndef testxPosNNCode_H_
#define testxPosNNCode_H_
...
class testxPosNNCode : public Catoms3DBlockCode
{
private:
...
public:
    bool isLeader = false;
    testxPosNNCode(Catoms3DBlock *host);
    ~testxPosNNCode(){};
    ...
    {
        return (new testxPosNNCode((Catoms3DBlock *)host));
    }
    /*****************************************************************************/
};

#endif /* testxPosNNCode_H_ */